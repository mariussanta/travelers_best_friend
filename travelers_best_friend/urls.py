"""travelers_best_friend URL Configuration
...
from users_app import views as user_app_views
...
urlpatterns = [
    ...
    path('profile/', user_app_views.profile, name='profile'),
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='users_app/password_reset.html'),
         name='password_reset'),
    ...
    path('', include('travelers_best_friend_app.urls')),
